<template>
  <div>
    <br>
    <h1 class="title" @click="updateRecipes">My Favorites</h1>
    <div class="favorites-container">
      ...
      <!-- If not loading and there are recipes, display them in a grid -->
      <div v-else-if="recipes.length" class="favorites-grid">
        <RecipePreview v-for="r in recipes" :key="r.id" :recipe="r" />
      </div>
      <!-- If not loading and there are no recipes, display a message -->
